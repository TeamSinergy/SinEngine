...
protected:
    ...
    VertexShader* VShader = ResourceManager::FindResourceType<VertexShader>("Default.vert");    // the vertex shader
	PixelShader* PShader = ResourceManager::FindResourceType<PixelShader>("Default.pix");     // the pixel shader
